...
package cn.vlabs.dconvert.utils;
...
public class Config {
	...
	private Config() {
		...
		String appRootPath=System.getProperty("dconvert.appRoot");
		String dconvertConfPropPath=appRootPath+"WEB-INF"+File.separator+"conf"+File.separator+"dconvertconfig.properties";
		Resource res=new FileSystemResource(dconvertConfPropPath);
		try {
	...
	/*private String guessPath() {
		String result = System.getProperty(CONF_DIR);
